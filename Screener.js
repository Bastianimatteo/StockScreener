array = ["UCG.MI", "ISP.MI", "ENEL.MI", "ENI.MI", "STLAM.MI", "LVMH.MI", "AAPL", "MSFT", "GOOGL", "AMZN", "TSLA", "JNJ", "WMT", "NIO", "CSIQ", "MU", "PG", "ASML", "NVS", "NFLX", "QCOM", "SNY", "PFE", "RIVN", "RBLX", "NVDA", "U", "BE", "FCEL", "AMD", "BNTX", "META", "INTC", "PARA", "PLUG", "NKLA", "MRNA", "T", "BYND", "BAC", "PYPL", "KO", "GS", "JPM", "CGC", "SPWR", "TSM"];
...
for(let i=0, j=0; i<array.length; i++)
{
    ...
    xhttp_financial[i].onreadystatechange = function()
    {
        if(xhttp_financial[i].status == 200 && xhttp_financial[i].readyState ==4)
        {
            ...
            {
                v_gross_margin = data_financial[i].quoteSummary.result[0].financialData.grossMargins.raw;
            }
            else
            {
                v_gross_margin = 0;
            ...
            { 
                v_roe = data_financial[i].quoteSummary.result[0].financialData.returnOnEquity.raw;
            }
            else
            {
                v_roe = 0;
...
{      
    ...
    for(let i=0; i<now_name.length; i++)
    {
        ...
        {
            cell_gross_margin.innerHTML = (sorted_gross_margin[i]*100).toFixed(2) + " %";
        }              
        else
        {
        ...
        cell_roe.innerHTML = (sorted_roe[i]*100).toFixed(2) + " %";
        ...
        {
            cell_dividend.innerHTML = (sorted_dividend[i]*100).toFixed(2) + " %";                
        }
        else
        {
...
function colors()
{
    ...
    for(let i=0; i<tr.length; i++)
    {
        ...
        {
            td[change_position].style.color ="red";
        }
    }
}
