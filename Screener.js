array = ["UCG.MI", "ISP.MI", "ENEL.MI", "ENI.MI", "LVMH.MI", /*"STLAM.MI",*/ "AAPL", "MSFT", "GOOGL", "AMZN", "TSLA", "NIO", "CSIQ", "MU", "PG", "ASML", "NFLX", "QCOM", "PFE", "RIVN", "RBLX", "NVDA", "U", "BE", "FCEL", "AMD", "META", "INTC", "PARA", "PLUG", "NKLA", "T", "BYND", "BAC", "PYPL", "KO", "GS", "JPM", "CGC", "SPWR", "TSM", "NEL.OL", "RUN", "SNY", "NVS", "JNJ", "BNTX", "MRNA"];
...
function table_crypto()
{
    ...
    for(let i=0; i<data_crypto.length; i++)
    {
        ...
        data_crypto[i].regularMarketPrice > 1 ? (cell_price_crypto.innerHTML = (data_crypto[i].quoteResponse.result[0].regularMarketPrice).toFixed(2)) : (cell_price_crypto.innerHTML = (data_crypto[i].quoteResponse.result[0].regularMarketPrice).toFixed(3));
